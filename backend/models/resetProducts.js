...
const productsData = [
  ...
  // 2 Satellites
  {
    ...
    specs: ["Battery: Up to 240 minutes talk time", "Release Date: 2011-11-01"],
    image: "/uploads/sat1.jpg",
  },
  {
    ...
    specs: ["Battery: Up to 480 minutes talk time", "Release Date: 2014-03-01"],
    image: "/uploads/sat2.jpg",
  },
...
const resetProducts = async () => {
  try {
    ...
    console.log(`${created.length} products reseeded`);
