      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <Link
              to="/"
              className="text-2xl font-bold bg-linear-to-r from-purple-400 to-blue-500 bg-clip-text text-transparent"
            >
              SECURECOMM GLOBAL
            </Link>
            ...
            {isLoginPage && (
              <Link
                to="/register"
                className="px-3 sm:px-6 py-2 bg-linear-to-r from-purple-600 to-blue-600 rounded-full font-semibold hover:shadow-lg hover:shadow-purple-500/50 transition-all hover:scale-105 text-xs sm:text-sm sm:text-base whitespace-nowrap"
              >
                SIGN UP
              </Link>
            )}
          ...
          <div className="bg-gradient-to-br from-purple-900/30 to-blue-900/30 rounded-3xl p-6 sm:p-8 backdrop-blur-sm border border-purple-500/30 shadow-2xl shadow-purple-600/40">
            <form onSubmit={handleLogin} className="space-y-5 sm:space-y-6">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3 sm:py-4 bg-linear-to-r from-purple-600 to-blue-600 rounded-full font-bold text-base sm:text-lg hover:shadow-xl hover:shadow-purple-500/50 transition-all hover:scale-105 disabled:opacity-70 disabled:cursor-not-allowed"
              >
