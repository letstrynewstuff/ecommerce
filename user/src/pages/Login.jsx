        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-gradient-to-br from-purple-900/30 to-blue-900/30 rounded-3xl p-8 backdrop-blur-sm border border-purple-500/30 shadow-2xl shadow-purple-600/40">
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              {message && <div className="mt-4 p-4 bg-green-900/50 border border-green-500 rounded-xl text-center text-green-300">{message}</div>}
              {error && <div className="mt-4 p-4 bg-red-900/50 border border-red-500 rounded-xl text-center text-red-300">{error}</div>}
            </form>
