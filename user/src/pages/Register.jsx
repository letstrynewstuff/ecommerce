...
//                     <label
//                       key={option}
//                       className="flex items-center justify-center py-3 bg-slate-900/70 border border-purple-500/40 rounded-xl cursor-pointer hover:bg-purple-900/40 transition-all"
//                     >
//                       <input
//                         type="radio"
//                         name="gender"
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 flex items-center justify-center min-h-screen">
        <div className="max-w-lg w-full">
          <div className="text-center mb-10">
            ...
            <p className="text-xl text-gray-300">
              Join SecureComm Global for encrypted communication and secure delivery
            </p>
          </div>
